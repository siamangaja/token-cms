...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_profile_details" class="collapse show">
        ...
        <!--begin::Form-->
        <form id="" class="form" action="{{url('admin/partner/add')}}" method="POST" enctype="multipart/form-data">
        @csrf
            <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="link" class="form-control form-control-lg form-control-solid" placeholder="" required/>
                    </div>
                    <!--end::Col-->
                </div>
