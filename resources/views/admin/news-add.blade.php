...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_profile_details" class="collapse show">
        ...
        <!--begin::Form-->
        <form id="" class="form" action="{{url('admin/news/add')}}" method="POST" enctype="multipart/form-data">
        @csrf
            <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <input type="file" name="thumbnail" class="form-control form-control-lg form-control-solid" required/>
                    </div>
                    <!--end::Col-->
                </div>
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <a href="{{url('admin/news')}}" class="btn btn-light btn-active-light-primary me-2">Back</a>
