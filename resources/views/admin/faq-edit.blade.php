...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_profile_details" class="collapse show">
        ...
        <!--begin::Form-->
        <form id="" class="form" action="{{url('admin/faq/'.$data->id.'/edit')}}" method="POST" enctype="multipart/form-data">
        @csrf
            <!--begin::Card body-->
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <a href="{{url('admin/faqs')}}" class="btn btn-light btn-active-light-primary me-2">Back</a>
