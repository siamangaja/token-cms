                ...
                <table id="kt_profile_overview_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bolder">
                    ...
                    <tbody class="fs-6">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="admin/page/{{$d->id}}/edit"><span class="btn btn-dark btn-sm"><i class="fa fa-file"></i> Edit</span></a> <a href="admin/page/{{$d->id}}/delete" onclick="return confirm('Are you sure to delete?')"><span class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Del</span></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
